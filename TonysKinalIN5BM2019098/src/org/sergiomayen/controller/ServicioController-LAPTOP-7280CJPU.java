...
public void seleccionarElemento(){
   ...
   public void imprimirReporte(){
       ...
       int id = Integer.valueOf(((Empresa)cmbCodigoEmpresa.getSelectionModel().getSelectedItem()).getCodigoEmpresas());
       parametros.put("id", id);
       GenerarReporte.mostrarReporte("ReporteServiciosFinal", "Reporte de Servicios", parametros);
