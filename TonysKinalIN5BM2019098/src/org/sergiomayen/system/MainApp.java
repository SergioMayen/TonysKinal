...
public void ventanaProgramador(){
    ...
    try{
        empresasController EmpresaController = (empresasController)cambiarEscena("EmpresasView.fxml",692,457);
    ...
    public void ventanaEmpleado(){
        try{
            EmpleadoController Empleado = (EmpleadoController)cambiarEscena("EmpleadoView.fxml",755,540);
    ...
    public void ventanaServicio(){
            try{
                ServicioController servicio = (ServicioController)cambiarEscena("ServiciosView.fxml",759,418);
